...
This file mirrors the active project rules in `AGENTS.md` for Claude Code workflows.
If `CLAUDE.md` and `AGENTS.md` ever diverge, treat `AGENTS.md` as the source of truth and resync this file.
...
Claude Code should treat this repository as a **multi-app workspace**, not a single-root app.
