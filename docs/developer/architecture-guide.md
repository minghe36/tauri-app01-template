...
│   └── src-tauri/       # Desktop Tauri/Rust app
packages/
├── i18n/                # Shared translations and i18n bootstrap
└── config/              # Shared frontend config presets
```
...
**Location:** `apps/desktop/src-tauri/capabilities/default.json`
...
CSP prevents XSS attacks. Configuration is in `apps/desktop/src-tauri/tauri.conf.json`.
