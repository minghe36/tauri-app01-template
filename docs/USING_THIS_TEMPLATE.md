...
| `apps/desktop/index.html`                | `<title>` tag                                                                  |
| `apps/desktop/src-tauri/tauri.conf.json` | `productName`, `identifier`, `windows[0].title`, bundle info, updater endpoint |
| `apps/mobile/src-tauri/tauri.conf.json`  | `productName`, `identifier`, `windows[0].title`, bundle info, frontend wiring  |
| `apps/desktop/src-tauri/Cargo.toml`      | `name`, `description`, `authors`                                               |
...
- `apps/mobile/src-tauri/tauri.conf.json` is the mobile Tauri shell config.
- It currently reuses the desktop frontend bundle from `apps/desktop/dist`.
- Shared app icons for both desktop and mobile live in `crates/icons`.
...
Add your public key to `apps/desktop/src-tauri/tauri.conf.json`:
